<div class="w-full rounded-lg border border-gray-200 bg-white shadow-sm">
    ...
    <div class="p-4 border-b">
        <div class="flex items-center p-2">
            ...
            <label for="card" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300 cursor-pointer">Using Credit / Debit Card</label>
        </div>
        <?php include( App\Core\Application::BASE_PATH . 'partials/payment/card.php'); ?>
    </div>
    <div class="p-4 border-b">
        <div class="flex items-center p-2">
